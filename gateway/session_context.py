...
# Native gateway launch authority; never populated from process environment.
completion_launch_context: ContextVar = ContextVar("completion_launch_context", default=None)
