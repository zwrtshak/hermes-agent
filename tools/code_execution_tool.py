...
_TOOL_STUBS = {
    ...
    "terminal": (
        "terminal",
        "command: str, timeout: int = None, workdir: str = None, continuation: dict = None, continuation_ticket: dict = None",
        '"""Run a shell command (foreground only). Returns dict with "output" and "exit_code"."""',
        '{"command": command, "timeout": timeout, "workdir": workdir, "continuation": continuation, "continuation_ticket": continuation_ticket}',
    ),
}
